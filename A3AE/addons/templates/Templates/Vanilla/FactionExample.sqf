...
["name", "GER"] call _fnc_saveToTemplate;
["spawnMarkerName", "GER Support Corridor"] call _fnc_saveToTemplate;
...
_militaryLoadoutData set ["uniforms", ["U_LIB_GER_Schutze_HBT"]];
_militaryLoadoutData set ["vests", ["V_LIB_GER_VestSTG"]];
_militaryLoadoutData set ["backpacks", ["B_LIB_GER_A_frame"]];
_militaryLoadoutData set ["helmets", ["H_LIB_GER_Helmet_ns"]];
